...
describe 'transform_position under UTF-32', ->
	transform_position.encoder = require('lsp-lib.transform.position.utf32')
		...
		it 'works with larger code points', ->
			...
			expected_values = {
				...
				[0]: {
					...
					[1]: 5
					[2]: 9
					[3]: 9 -- clamp to previous byte position
				}
				[1]: {
					[-1]: 'UTFCharNegative'
					[0]: 10
					[1]: 14
					[2]: 18
					[3]: 18 -- clamp to previous byte position
				}
				[2]: {
					[-1]: 'UTFCharNegative'
					[0]: 19
				...
				[3]: {
					...
					[1]: 24
					[2]: 28
					[3]: 28 -- clamp to previous byte position
				}
				[4]: {
					[-1]: 'UTFCharNegative'
					[0]: 30
					[1]: 34
					[2]: 34 -- clamp to previous byte position
				}
				[5]: {
					[-1]: 'UTFCharNegative'
					[0]: 35
					[1]: 39
					[2]: 39 -- clamp to previous byte position
				}
				[6]: { [0]: 'LineOutOfRange' }
			}
